...
if choice2 == "up":
    ...
    # Third choice
    choice3 = input(
        "Do you approach the mirror, or continue searching the chamber? Type 'approach mirror' or 'search further': ").lower()

    if choice3 == "approach mirror":
        print(
            "You cautiously step closer to the mirror. Your reflection appears distorted, but faint whispers fill the air.")
        print(
            "Suddenly, you hear a hissing sound. A song plays in your head: 'Your hair is a thousand snakes, hissing with venom. Both demon and fairy, curse in my nights, leaving wounds.'")
...
She hands you the vial and fades back into the shadows. The temple grows quiet once more, and the Tear Crystal gleams in your hands.""")
            print(
                "You’ve gained the Tear Crystal! Your loved ones are restored. Congratulations, you've broken the curse!")
        else:
            print("You run, but the snakes catch you. Game over.")
    elif choice3 == "search further":
        print(
            "As you search further, you trip on a hidden pressure plate. Traps spring to life, and the room collapses. Game over.")
    else:
